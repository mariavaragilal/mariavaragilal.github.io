...
export const buildPersonStructuredData = (mv, site) => ({
	...
	hasOccupation: { '@type': 'Occupation', name: mv.intro.schemaJobTitle, description: mv.seo.occupationDescription, skills: site.skills },
...
export const buildWebsiteStructuredData = (mv, site) => ({
	'@context': 'https://schema.org',
	'@type': 'WebSite',
	name: site.author + ' — ' + mv.intro.schemaJobTitle,
	description: mv.seo.defaultDescription,
	url: site.siteUrl,
