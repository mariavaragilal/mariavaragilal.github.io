		...
		<Layout title={t("cv.name")} description={t("cv.title")}>
			<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 p-8 border-b border-slate-200 dark:border-slate-700">
				<div className="block w-full">
					<h1 className="text-7xl/15 font-bold text-slate-800 dark:text-slate-100 max-w-xs min-h-[7.5rem] font-[Rubik] tracking-tighter">{t('cv.name')}</h1>
				</div>
				<div className="block mt-auto">
					<p className="text-[1.5em] text-slate-800 dark:text-slate-100 mb-0">{t('location')}</p>
					<p className="text-[1.5em] text-slate-800 dark:text-slate-100 font-bold mt-0 mb-0 w-full">{t('cv.title')}</p>
					<a href="https://www.linkedin.com/in/mariavaragilal" target="_blank" rel="noopener noreferrer" className="text-[1em] text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 hover:underline">linkedin.com/in/mariavaragilal</a>
				</div>
				<div className="text-[1em] text-slate-600 dark:text-slate-300 mt-auto sm:col-span-2 lg:col-span-1 flex gap-y-1 gap-x-6 lg:gap-x-0 flex-wrap">
					<p className="flex flex-wrap gap-x-2">
						🔗
						<a href="https://codepen.io/mariavaragilal" target="_blank" rel="noopener noreferrer" className="text-[1em] text-slate-800 dark:text-slate-100 hover:text-blue-600 dark:hover:text-blue-400 hover:underline">codepen.io/mariavaragilal</a>
					</p>
					<p className="flex flex-wrap gap-x-2 lg:w-full">
						🏀
						<a href="https://dribbble.com/mariavaragilal" target="_blank" rel="noopener noreferrer" className="text-[1em] text-slate-800 dark:text-slate-100 hover:text-blue-600 dark:hover:text-blue-400 hover:underline">dribbble.com/mariavaragilal</a>
					</p>
					<p className="flex flex-wrap gap-x-2">
						🐝
						<a href="https://be.net/mariavaragilal" target="_blank" rel="noopener noreferrer" className="text-[1em] text-slate-800 dark:text-slate-100 hover:text-blue-600 dark:hover:text-blue-400 hover:underline">be.net/mariavaragilal</a>
					</p>
				</div>
			</div>
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
				...
				<div className="p-8 space-y-12 border-r border-slate-200 dark:border-slate-700">
					{/* About Section */}
					<section>
						<h2 className="font-[Rubik] tracking-tighter text-4xl text-slate-800 dark:text-slate-100 font-bold mb-3">{t('nav.about')}</h2>
					...
					{/* Education Section */}
					<section>
						<h2 className="font-[Rubik] tracking-tighter text-4xl text-slate-800 dark:text-slate-100 font-bold mb-3">{t('nav.education')}</h2>
						<div className="space-y-4">
							<div className=" pb-4 border-b border-slate-200 dark:border-slate-700">
								<h3 className="text-[1.25em] text-slate-800 dark:text-slate-100 pr-4 leading-tight font-bold">
									<a href="https://www.ulusiada.pt" target="_blank" rel="noopener noreferrer" className="text-slate-800 dark:text-slate-100 hover:text-blue-600 dark:hover:text-blue-400 hover:underline">{t('education.university.name')}</a>
								</h3>
							...
							<div>
								<h3 className="text-[1.25em] text-slate-800 dark:text-slate-100 font-bold">
									<a href="https://flag.pt/academias" target="_blank" rel="noopener noreferrer" className="text-slate-800 dark:text-slate-100 hover:text-blue-600 dark:hover:text-blue-400 hover:underline">{t('education.academy.name')}</a>
								</h3>
					...
					{/* Awards Section */}
					<section>
						<h2 className="font-[Rubik] tracking-tighter text-4xl text-slate-800 dark:text-slate-100 font-bold mb-3">{t('nav.awards')}</h2>
						<div className="space-y-4">
							<div className=" pb-4 border-b border-slate-200 dark:border-slate-700">
								<h3 className="text-[1.25em] text-slate-800 dark:text-slate-100 font-bold">
									<a href="https://www.canneslions.com/festival" target="_blank" rel="noopener noreferrer" className="text-slate-800 dark:text-slate-100 hover:text-blue-600 dark:hover:text-blue-400 hover:underline">{t('awards.younglions.name')}</a>
								</h3>
							...
							<div>
								<h3 className="text-[1.25em] text-slate-800 dark:text-slate-100 font-bold">
									<a href="https://www.behance.net/mariavaragilal" target="_blank" rel="noopener noreferrer" className="text-slate-800 dark:text-slate-100 hover:text-blue-600 dark:hover:text-blue-400 hover:underline">{t('awards.behance.name')}</a>
								</h3>
				...
				<div className="p-8 lg:pr-10 lg:pl-4 space-y-16 lg:col-span-2">
					{/* Experience Section */}
					<section>
						<h2 className="font-[Rubik] tracking-tighter text-4xl text-slate-800 dark:text-slate-100 font-bold mb-3">{t('nav.experience')}</h2>
						<div className="space-y-12">
							...
							<div className="pb-12 border-b border-slate-200 dark:border-slate-700">
								<div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
									<div className="block">
										<h3 className="text-[1.25em] text-slate-800 dark:text-slate-100 font-bold">
											<a href="https://www.securibox.eu" target="_blank" rel="noopener noreferrer" className="text-slate-800 dark:text-slate-100 hover:text-blue-600 dark:hover:text-blue-400 hover:underline">{t('experience.securibox.company')}</a>
										</h3>
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-12 border-b border-slate-200 dark:border-slate-700">
								<div>
									<h3 className="text-[1.25em] text-slate-800 dark:text-slate-100 font-bold">
										<a href="https://www.youngnetworkgroup.com/" target="_blank" rel="noopener noreferrer" className="text-slate-800 dark:text-slate-100 hover:text-blue-600 dark:hover:text-blue-400 hover:underline">{t('experience.youngnetwork.company')}</a>
									</h3>
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-12 border-b border-slate-200 dark:border-slate-700">
								<div>
									<h3 className="text-[1.25em] text-slate-800 dark:text-slate-100 font-bold">
										<a href="https://www.infoportugal.pt" target="_blank" rel="noopener noreferrer" className="text-slate-800 dark:text-slate-100 hover:text-blue-600 dark:hover:text-blue-400 hover:underline">{t('experience.infoportugal.company')}</a>
									</h3>
