...
export const ContactSection = () => (
	<section id='contact' aria-labelledby='contact-heading' className='px-6 py-16 lg:px-12'>
		<div className='mx-auto max-w-full grid gap-x-10 gap-y-6 md:grid-cols-2'>
			<div>
				<p className='text-[.8em] uppercase tracking-[0.2em] font-semibold text-current/66 mb-3'>Get in touch</p>
				<h2 id='contact-heading' className='mb-4 font-[Rubik] font-medium text-[24px] leading-tight text-foreground sm:text-[28px]'>
			...
			<nav className='p-0 mt-auto' aria-label='External profiles'>
				<a
					...
					target='_blank'
					rel='noreferrer'
					className={'flex items-center justify-between border-b border-border py-4 text-sm text-foreground min-h-[44px] ' + focusRing}
				>
					<span className='text-[.8em] uppercase tracking-[0.18em] text-current/66'>Dribbble</span>
				...
				<a
					...
					className={'flex items-center justify-between border-b border-border py-4 text-sm text-foreground min-h-[44px] ' + focusRing}
				>
					<span className='text-[.8em] uppercase tracking-[0.18em] text-current/66'>CodePen</span>
				...
				<a
					...
					className={'flex items-center justify-between border-b border-border py-4 text-sm text-foreground min-h-[44px] ' + focusRing}
				>
					<span className='text-[.8em] uppercase tracking-[0.18em] text-current/66'>Behance</span>
