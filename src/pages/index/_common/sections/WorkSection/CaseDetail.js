...
export const CaseDetail = ({ app }) => {
	...
	const ariaMain = ui.caseStudyPrefix + ' ' + app.title;
	return (
		<main className='flex-1 lg:overflow-y-auto p-8 pb-0 lg:p-10 flex flex-col gap-6 xl:gap-16' aria-label={ariaMain}>
