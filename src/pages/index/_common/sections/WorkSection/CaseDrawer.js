					...
					<div className='flex flex-col lg:flex-row h-full overflow-y-auto lg:overflow-y-hidden'>
						...
						<nav className='sticky z-10 top-0 left-0 flex flex-wrap lg:flex-col lg:h-full gap-5 items-center shrink-0 bg-secondary/50 p-4 xl::p-4 justify-between'>
							...
							<div className='flex lg:flex-col gap-2'>
								<Button variant='secondary' size='icon' className='size-8' onClick={goPrev} disabled={!hasPrev} aria-label='Previous case'>←</Button>
								<Button variant='secondary' size='icon' className='size-8' onClick={goNext} disabled={!hasNext} aria-label='Next case'>→</Button>
							</div>
						</nav>
