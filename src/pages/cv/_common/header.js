	...
	return (
		<header className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 p-8 border-b border-border'>
			...
			<nav className='p-0 mt-auto' aria-label='External profiles'>
				...
				<a href='https://github.com/mariavaragilal/' target='_blank' rel='noreferrer' className={'flex items-center justify-between border-b border-border py-2 text-sm text-foreground ' + focusRing}>
					<span className='text-[.75em] uppercase tracking-[0.18em] text-current/66'>Github</span>
					<span className='text-[1em] text-foreground hover:text-primary hover:underline'>github.com/mariavaragilal/ →</span>
					<span className={srOnly}> (opens in new tab)</span>
				</a>
